...
class YafaRay3SceneProperties(bpy.types.PropertyGroup):
    pass

@replace_properties_with_annotations
class YafaRay3LoggingProperties(bpy.types.PropertyGroup):
...
@replace_properties_with_annotations
class YafaRay3NoiseControlProperties(bpy.types.PropertyGroup):
...
@replace_properties_with_annotations
class YafaRay3LayersProperties(bpy.types.PropertyGroup):
    ...
    __renderInternalPassAdvanced = sorted((
    ...
    __renderPassItemsAO = sorted((
        ('ao', "AO", "Ambient Occlusion", 501),
        ('ao-clay', "AO clay", "Ambient Occlusion (clay)", 502),
    ), key=lambda index: index[1])

    __renderPassAllItems = sorted(
        __renderPassItemsBasic + __renderInternalPassAdvanced + __renderPassItemsIndex + __renderPassItemsDebug + __renderPassItemsDepth + __renderPassItemsAO,
        key=lambda index: index[1])
    ...
    pass_Combined = EnumProperty(
        ...
        items=(__renderPassItemsDisabled
               ),
        default="disabled")
...
@replace_properties_with_annotations
class YafaRay3MaterialPreviewControlProperties(bpy.types.PropertyGroup):
    enable = BoolProperty(
