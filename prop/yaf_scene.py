...
if bpy.app.version >= (2, 80, 0):
    from .yaf_scene_property_groups import YafaRay4LayersProperties, YafaRay4MaterialPreviewControlProperties, YafaRay4NoiseControlProperties, YafaRay4LoggingProperties
else:
    from .yaf_scene_property_groups_279 import YafaRay4LayersProperties, YafaRay4MaterialPreviewControlProperties, YafaRay4NoiseControlProperties, YafaRay4LoggingProperties
