...
if sys.platform == 'win32':
    ...
    if sys.maxsize == 2**63 - 1:    # Linux 64bit system
        dllArray = ['libHalf.so.6.0.0', 'libIex.so.6.0.0', 'libImath.so.6.0.0', 'libIlmThread.so.6.0.0', 'libIlmImf.so.6.0.0', 'libpython3.4m.so.1.0', 'libjpeg.so.62.0.0', 'libz.so.1.2.3.4', 'libpng12.so.0.44.0', 'libtiff.so.4.3.3', 'libfreetype.so.6.6.0', 'libboost_system-mt', 'libboost_filesystem-mt', 'libboost_serialization-mt', 'libyafaray_v3_core.so', 'libyafaray_v3_plugin.so']
