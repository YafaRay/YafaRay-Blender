    ...
    if bg_type == 'Texture':
        ...
        if world_tex is not None:
            ...
            if world_tex.type == "IMAGE" and (world_tex.image is not None):
                ...
                scene_yafaray.create_texture("world_texture", param_map)
                param_map = libyafaray4_bindings.ParamMap()
                ...
                # param_map.set_float("ibl_clamp_sampling", world.ibl_clamp_sampling) #No longer needed after
                ...
                if is_preview:
                    ...
                    param_map.set_float("smartibl_blur", 0.0)
                else:
