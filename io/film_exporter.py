...
class FilmExporter:
    ...
    def render(self):
        self.film.film_yafaray.setFlushAreaCallback(self.flush_area_callback)
        self.film.film_yafaray.setFlushCallback(self.flush_callback)
        self.film.film_yafaray.setHighlightAreaCallback(self.highlight_callback)
