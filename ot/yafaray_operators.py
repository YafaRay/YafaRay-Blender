...
class RENDER_OT_render_view(Operator):
    ...
    def poll(cls, context):
        ...
        return context.scene.render.engine == 'YAFA_E3_RENDER'

    def execute(self, context):
        view3d = context.region_data
        bpy.types.YAFA_E3_RENDER.useViewToRender = True
        ...
        if not view3d or view3d.view_perspective == "ORTHO":
            ...
            bpy.types.YAFA_E3_RENDER.viewMatrix = view3d.view_matrix.copy()
