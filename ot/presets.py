...
class RenderPresets(Operator):
    ...
    preset_values = [
        ...
        "scene.yafaray4.passes.pass_IndexOB",
        "scene.yafaray4.passes.pass_IndexMA",
        "scene.yafaray4.passes.pass_DiffDir",
        "scene.yafaray4.passes.pass_DiffInd",
        "scene.yafaray4.passes.pass_DiffCol",
        "scene.yafaray4.passes.pass_GlossDir",
        "scene.yafaray4.passes.pass_GlossInd",
        "scene.yafaray4.passes.pass_GlossCol",
        "scene.yafaray4.passes.pass_TransDir",
        "scene.yafaray4.passes.pass_TransInd",
        "scene.yafaray4.passes.pass_TransCol",
        "scene.yafaray4.passes.pass_SubsurfaceDir",
        "scene.yafaray4.passes.pass_SubsurfaceInd",
        "scene.yafaray4.passes.pass_SubsurfaceCol"
    ]
